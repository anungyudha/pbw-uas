...
<!-- article end -->
    ...
    <section id="aboutme" class="text-center p-5 bg-info-subtle">
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-center">
          <div class="p-3">
            <img
              src="https://mahasiswa.dinus.ac.id/images/foto/A/A11/2023/A11.2023.15134.jpg"
              class="rounded border shadow"
              width="150"
            />
          </div>
          <div class="p-md-5 text-sm-start">
            <h3 class="lead">A11.2023.15134</h3>
            <h1 class="fw-bold">Anung Yudha Pamungkas</h1>
    ...
    <footer id="footer" class="text-center p-5">
      <div>
        <a href="https://www.instagram.com/anungyudha" target="_blank"
          ><i class="bi bi-instagram h2 p-2"></i
        ></a>
        <a href="https://twitter.com/yudhadalopez" target="_blank"
      ...
      <div>Anung Yudha Pamungkas &copy; 2025</div>
    </footer>
    <!-- footer end -->
    ...
    <script type="text/javascript">
      document.getElementById("dark").onclick = function () {
        ...
        document
          .getElementById("hero")
          .classList.add("bg-secondary", "text-black");
